...
private:
	...
	BigInteger AbsSub( const BigInteger&, const BigInteger& ); //Sub regardless of sign
	BigInteger AbsAdd( const BigInteger&, const BigInteger& ) ; //Add regardless of sign
