...
typedef BinomialHeap<Tuple>* HeapList;

bool operator > ( Tuple&t1, Tuple&t2);
inline void merge(int computerID1, int computerID2, int minTask, HeapList taskQueues );
inline void execute( int computerID, HeapList taskQueues);
inline void assign( int computerID, int taskID, int priority, HeapList taskQueues );
